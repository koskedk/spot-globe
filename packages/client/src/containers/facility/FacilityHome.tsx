    ...
    render() {
        return (
            <div>
                ...
                {this.state.agencies ?
                    <FacilityList agencies={this.state.agencies} onDelete={this.deleteAgency} onEdit={this.editAgency}/> :
                    <div></div>}

                <Dialog header="Agency" visible={this.state.showForm} style={{width: '50vw'}} onHide={this.onHide}
                        maximizable>
                    <FacilityForm onFormSubmitted={this.saveAgency} agency={this.state.activeAgency}/>
                </Dialog>
            </div>);
    }
}
