...
const url = `http://${window.location.hostname}:4710/api/v1/practices/mechanisms/`;
const agenciesUrl = `http://${window.location.hostname}:4710/api/v1/practices/agencies/`;
